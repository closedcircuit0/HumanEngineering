...
More importantly, it fails to explain the ultimate goal (the Highest Value) that The Self pursues, and the means (the risk/return assessment) it uses to achieve that goal. A map lists the names of territories, but it does not tell you by what geological forces those territories were formed.

This article proposes a new map of The Self — or rather, the very ‘art of surveying’ itself. The ‘I’ is not a fixed territory to be discovered, but a ‘navigational system’ that dynamically predicts and corrects its course moment by moment to navigate the uncertain sea of this world.

We will descend into the deepest engine room of this system and confront the two absolute laws that govern it. By the end of this journey, you will realize that the true meaning of ‘self-discovery’ is not a romantic expedition to find a hidden treasure, but a deeply pragmatic matter of ‘Self-Engineering’ — of understanding the blueprints of the predictive engine within you and taking the helm.
...
Once the benchmark of ‘The Self’ is established, the success and failure of predictions are no longer simple information. They trigger qualitatively different emotions depending on whether they ‘verify,’ ‘advance,’ ‘stagnate,’ or ‘threaten’ one’s self-model, i.e., one’s ‘Highest Value.’

And this emotion, in turn, is not just a final output; it forms a powerful ‘Ego-Feedback Loop’ that modifies or reinforces the self-model, relentlessly sculpting The Self.
...
It is to become a ‘Self-Engineer’ who decides what one’s true ‘Highest Value’ is, and, to realize that value, when to step on the gas pedal (challenge), when to apply the brakes (stability), and when to boldly update the navigation (self-model).

You are the architect of your own self, and the art of skillfully handling that blueprint, we call that Wisdom.
